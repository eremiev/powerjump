...
@section('content')
    ...
    <div class="container">
        ...
        <div class="bs-component">
            <div class="jumbotron">
                <p class="text-center">
                    <img width="50%" src="{{ asset('images/sport-safari.jpg') }}" alt="">
                </p>
                <p>Kлуб Power Jump предоставя джипове и ATV под наем. Организира вълнуващи разходки Offroad с четириколки - ATV в група с водач, в които могат да се осъществят дневно максимум до 8 тура.
